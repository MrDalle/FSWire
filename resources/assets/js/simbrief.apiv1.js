...
function do_simbriefsubmit(outputpage)
	...
	/*if (api_code == null || api_code == false || typeof(api_code) == 'undefined')
		...
		*/
	//GET API CODE VIA AJAX CALL
        //console.log(document.getElementsByName('orig')[0].value);
        //console.log(document.getElementsByName('dest')[0].value);
        //console.log(document.getElementsByName('type')[0].value);
        //console.log(timestamp);
        //console.log(outputpage_calc);
        axios.get('/api/simbrief/getapicode', {
            params: {
                api_req: document.getElementsByName('orig')[0].value+document.getElementsByName('dest')[0].value+document.getElementsByName('type')[0].value+timestamp+outputpage_calc
            }
        })
            .then(function (response) {
                //console.log(response.data);
                api_code = response.data;
...
function Redirect_caller()
	...
	*/
	...
	if (fe_result == null || fe_result == false || typeof(fe_result) == 'undefined')
        ...
        axios.get('/api/simbrief/checkpageexist', {
                params: {
                    js_url_check: ofp_id,
                    var: 'fe_result'
                }
